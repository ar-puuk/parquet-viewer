...
interface AppStore {
  ...
  setGeoEpsg: (epsg: number | null, proj4String?: string | null) => void
  clearFile: () => void
...
export const useAppStore = create<AppStore>((set) => ({
  ...
  setGeoEpsg: (epsg, proj4String) => set((state) => {
    if (!state.geoInfo) return {}
    return { geoInfo: { ...state.geoInfo, epsg, proj4String: proj4String ?? null, isWGS84: epsg == null || epsg === 4326 } }
  }),
